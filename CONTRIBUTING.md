...
+ Here's what the final result would look like:
+
+ ![Final result](../assets/images/78fcCsF.png)
+
...
There are also some shortcuts you can use for the `avatar` attribute. The currently available ones are "blue", "gray", "green", "orange", "red", and "djs". The color values will make it use a default Discord avatar of that color, and "djs" will make it use the discord.js guild icon.
